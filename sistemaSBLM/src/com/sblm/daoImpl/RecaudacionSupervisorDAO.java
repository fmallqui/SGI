...
public class RecaudacionSupervisorDAO implements IRecaudacionSupervisorDAO, Serializable {
	...
	public int obtenerNumeroDocumentosMes(String respuesta,
		...
		Long count = (Long) sessionFactory.openSession()
		.createQuery("select COUNT(IDFLUJODOCUMENTO) from Flujodocumento F  inner join F.usuario U  where  U.idusuario='"+FuncionesHelper.getUsuario().toString()+"' and F.estadosupervisor='derivado' and F.respuesta ='"+respuesta+"' and month(F.fecharecepcion)='"+mesActualcapturado+"' ").uniqueResult();
		return count.intValue();
	}
	...
	public int obtenerNumeroDocumentosMes(String respuesta) {
		Long count = (Long) sessionFactory.openSession()
		.createQuery("select COUNT(IDFLUJODOCUMENTO) from Flujodocumento F  inner join F.usuario U  where  U.idusuario='"+FuncionesHelper.getUsuario().toString()+"' and F.estadosupervisor='derivado' and F.respuesta ='"+respuesta+"'").uniqueResult();
		return count.intValue();
	}
...
/**/
	...
	public int obtenerNumeroDerivadosMes(int mesActualcapturado) {
		Long count = (Long) sessionFactory.openSession() 
				.createQuery("select COUNT(IDFLUJODOCUMENTO) from Flujodocumento  F   inner join F.usuario U where U.idusuario='"+FuncionesHelper.getUsuario().toString()+"' and F.estadosupervisor='DERIVADO' and month(F.fechaderivacionsupervisor)='"+mesActualcapturado+"'  ").uniqueResult();
				return count.intValue();
	}
	...
	public int obtenerNumeroDerivados() {
		Long count = (Long) sessionFactory.openSession() 
				.createQuery("select COUNT(IDFLUJODOCUMENTO) from Flujodocumento  F   inner join F.usuario U where U.idusuario='"+FuncionesHelper.getUsuario().toString()+"' and F.estadosupervisor='DERIVADO' ").uniqueResult();
				return count.intValue();
	}
	...
	public int obtenerNumeroPendientes() {
		Long count = (Long) sessionFactory.openSession()
				.createQuery("select COUNT(IDFLUJODOCUMENTO) from Flujodocumento F inner join F.usuario U  where U.idusuario='"+FuncionesHelper.getUsuario().toString()+"' and F.estadosupervisor='NINGUNO' ").uniqueResult();
				return count.intValue();
	}
	...
	public int obtenerNumeroPendientesMes(int mesActualcapturado) {
		Long count = (Long) sessionFactory.openSession()
				.createQuery("select COUNT(IDFLUJODOCUMENTO) from Flujodocumento F inner join F.usuario U  where U.idusuario='"+FuncionesHelper.getUsuario().toString()+"' and F.estadosupervisor='NINGUNO' and month(F.fecharecepcion)='"+mesActualcapturado+"'  ").uniqueResult();
				return count.intValue();
	}
	...
	public List<Flujodocumento> getFlujoDocumentosSupervisorAtendidos(
		...
		if(mesSeleccionado==0){
			...
			list = session.createQuery("select new List(F.idflujodocumento,F.fechaderivacionsupervisor,D.titulo,D.nombreremitente,D.asunto,D.descripcion,U.idusuario,D.iddocumento,F.idusuarioremitente,F.respuesta,F.fechaaprobacionrechazo) from Flujodocumento  F   inner join F.usuario U inner join F.documento D where U.idusuario='"+FuncionesHelper.getUsuario().toString()+"' and F.estadosupervisor='DERIVADO'  and month(F.fechaderivacionsupervisor)='"+mesSeleccionado+"'order by F.fechaderivacionsupervisor desc").list();
		}
	...
	public List<Flujodocumento> getFlujoDocumentosSupervisor(int mesSeleccionado) {
		...
		if(mesSeleccionado==0){
			...
			list= session.createQuery("select new List(F.idflujodocumento,D.fechaderivaciondgai,D.titulo,D.nombreremitente,D.asunto,D.descripcion,U.idusuario,D.iddocumento,F.estadosupervisor,F.fecharecepcion,F.idusuarioremitente) from Flujodocumento F inner join F.usuario U  where U.idusuario='"+FuncionesHelper.getUsuario().toString()+"' and F.estadosupervisor='NINGUNO'  and month(F.fecharecepcion)='"+mesSeleccionado+"'  order by F.fecharecepcion desc").list();	
		}
	...
	public List<Flujodocumento> listaFiltroDocumentosMes(String respuesta) {
		...
		Calendar fecha = Calendar.getInstance();
		 ...
		 list = session.createQuery("select new List(F.idflujodocumento,F.fechaderivacionsupervisor,D.titulo,D.nombreremitente,D.asunto,D.descripcion,U.idusuario,D.iddocumento,F.idusuarioremitente,F.respuesta,F.fechaaprobacionrechazo) from Flujodocumento F inner join F.usuario U inner join F.documento D where U.idusuario='"+FuncionesHelper.getUsuario().toString()+"' and F.respuesta='"+respuesta+"' and  F.estadosupervisor='derivado' and Month(F.fechaderivacionsupervisor)='"+nroMes+"' order by F.fecharecepcion  desc").list();
