...
public  void settingLog(int idestadoauditoria, int ideventoauditoria, int idusuariodestino, String mensajePersonalizado){
	...
	public List<Perfilusuario> getPerfiles() {
		...
		list = session.createQuery("select new List(p.idperfil) from Perfilusuario pu inner join pu.usuario u inner join pu.perfil p where u.idusuario='"+FuncionesHelper.getUsuario().toString()+"'").list();
