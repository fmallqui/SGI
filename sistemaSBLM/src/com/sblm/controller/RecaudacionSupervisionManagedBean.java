...
//		System.out.println("entro metodo agregar");
//		
//		
//		int indice=0;
//		int indice2=0;
...
//			if(perfilesusuario.get(i).getPerfil().getIdperfil()==getIdPerfilSeleccionado()){
//				
//				indice=i;
//			}
//		}
...
//			if(todosUsuarios.get(i).getIdusuario()==getIdUsuarioSeleccionado()){
//				flag=true;
//				indice2=i;
//			}
//		}
...
//			
//			todosUsuarios.get(indice2).setUsrcre(perfilesusuario.get(indice).getPerfil().getNombreperfil());
//			todosUsuarios.get(indice2).setUsrmod(String.valueOf(perfilesusuario.get(indice).getPerfil().getIdperfil()));
//			
//			listaUsuariosEnvio.add(todosUsuarios.get(indice2));
//		}
//		
//	}
	...
	public void getFlujoDocumentosSupervisor(int mesSeleccionado){
		...
		System.out.println("---------------------------------------------------------->"+listFLujoDocumentosSupervisorPendiente.size());
	}
