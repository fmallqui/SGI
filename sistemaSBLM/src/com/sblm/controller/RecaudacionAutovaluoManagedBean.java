...
public class RecaudacionAutovaluoManagedBean implements Serializable {
	...
	Boolean visible;
	List<Perfilusuario> pu;
	
	@PostConstruct
	public void initObjects(){
		validarPerfilActual();
		inicializandoSeguimiento();
	...
	public void inicializandoSeguimiento(){
	...
	public void validarPerfilActual(){
		pu= new ArrayList<Perfilusuario>();
		pu=recaudacionAutovaluoService.getPerfiles();
		
//		for (int i = 0; i < pu.size(); i++) {
//			if(pu.get(0).getPerfil().getIdperfil()==FuncionesHelper.idperfilseleccionado){
//				visible=true;
//				}else{
//				visible=false;	
//				}
//		}
		...
		if(FuncionesHelper.idperfilseleccionado==123){
			visible=true;
	...
	public void getSeguimientoFlujoDocumentosPendientes(int mesSeleccionado){
		...
		System.out.println("000000000000000000000000000000000000000000000000"+listSeguimientoFLujoDocumentosAutovaluoPendiente.size());
		}
