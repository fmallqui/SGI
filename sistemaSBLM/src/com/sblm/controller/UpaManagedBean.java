...
//		numupas = getUpaService().obtenerNumeroRegistros();
	...
	public void registrarUpa() {
		...
		if (actualizado == true) {
			...
			if (inmueb == null) {
				...
				upa.getUbigeo().setDepa(valorDpto);
				upa.getUbigeo().setProv(valorProvincia);
				upa.getUbigeo().setDist(valorDistrito);
	...
	public void eliminarUpa() {
		...
		FacesMessage msg = new FacesMessage(FacesMessage.SEVERITY_INFO,
				"Exito", "Se eliminó el Upa del distrito de "
						+ upacapturado.getUbigeo().getDist()
						+ " correctamente.");
	...
	public void cargarComboProvincias() {
		...
		listaProvincias = getUpaService().listarProvincias(valorDpto);
	}

	public void cargarComboDistritos() {

		listaDistritos = getUpaService().listarDistritos(valorProvincia);
	}

	public void cargarUbigeo() {

		listaUbigeos = getUpaService().listarUbigeoPorDistrito(valorProvincia,
				valorDistrito);
	}

	public void cargarDdtoProvDist() {

		listaDptos = getUpaService().listarDptoPorUbigeo(
				upa.getUbigeo().getUbigeo());
		listaProvincias = getUpaService().listarProvinciaPorUbigeo(
				upa.getUbigeo().getUbigeo());
		listaDistritos = getUpaService().listarDistritoPorUbigeo(
				upa.getUbigeo().getUbigeo());
	}
