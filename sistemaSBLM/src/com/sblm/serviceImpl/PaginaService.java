...
public class PaginaService implements IPaginaService{
	...
	@Override
	public Pagina verificarPaginaEnModulo(String descripcionpagina,String nombrepagina, int idmodulo) {
		return getPaginaDAO().verificarPaginaEnModulo(descripcionpagina,nombrepagina,idmodulo);
	}
